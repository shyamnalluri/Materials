setwd("E:\\Records\\imp doc\\igcp\\Ppt- Teaching\\DS\\RCodes")
...
# All the feature values should be in same range, if not we should normalize 
...
which computes the inner product in feature space between two vector arguments"

# Different types of kernels 
# "rbfdot", "polydot", "tanhdot", "vanilladot", "laplacedot", 
# "besseldot", "anovadot", "splinedot", "matrix"

# kernel = rfdot--- Gaussian 
